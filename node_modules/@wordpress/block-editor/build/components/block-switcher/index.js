...
const BlockSwitcherDropdownMenu = ({
  ...
  const blockSwitcherDescription = 1 === blocks.length ? (0, _i18n.sprintf)( /* translators: %s: block title. */
  (0, _i18n.__)('%s: Change block type or style'), blockTitle) : (0, _i18n.sprintf)( /* translators: %d: number of blocks. */
