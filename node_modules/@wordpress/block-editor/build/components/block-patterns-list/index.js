...
function BlockPattern({
  ...
  }, pattern.type === 'user' && !pattern.syncStatus && (0, _element.createElement)("div", {
    className: "block-editor-patterns__pattern-icon-wrapper"
  }, (0, _element.createElement)(_icons.Icon, {
    className: "block-editor-patterns__pattern-icon",
    icon: _icons.symbol
  })), (!showTooltip || pattern.type === 'user') && (0, _element.createElement)("div", {
...
function BlockPatternList({
  ...
  }), pagingProps && (0, _element.createElement)(_blockPatternsPaging.default, {
    ...pagingProps
  }));
}
