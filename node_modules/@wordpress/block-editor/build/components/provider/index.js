...
const ExperimentalBlockEditorProvider = (0, _withRegistryProvider.default)(props => {
  ...
  return (0, _element.createElement)(_components.SlotFillProvider, {
    passthrough: true
  }, (0, _element.createElement)(_keyboardShortcuts.default.Register, null), (0, _element.createElement)(_blockRefsProvider.BlockRefsProvider, null, children));
});
